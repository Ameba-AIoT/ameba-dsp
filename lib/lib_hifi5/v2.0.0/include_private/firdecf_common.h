...
#ifndef _FIRDECF_COMMON_H_
#define _FIRDECF_COMMON_H_
...
proc_fxn_t fir_decimaf_2x;
proc_fxn_t fir_decimaf_3x;
proc_fxn_t fir_decimaf_4x;
proc_fxn_t fir_decimaf_Dx;
