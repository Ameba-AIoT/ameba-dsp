...
/*===========================================================================
    ...
    gs16   16-bit signed grayscale data (all negative values are black)
     ...
     - 'fast' functions which assume that the pointer for each row is 
       aligned on 16-byte boundary. This also means that the pointer to the 
...
/* image size:
   ...
   2. all the images should be aligned on 16-byte boundary
   3. stride should be a multiple of 16 for 8-bit grayscale, 8 for 16-bit 
      grayscale
*/
...
/*-------------------------------------------------------------------------
  ...
  1. see general restrictions applied for all images for fast/generic 
     functions
  2. pointer to the scratch memory should be aligned on 16-byte boundary
-------------------------------------------------------------------------*/
...
/*-------------------------------------------------------------------------
  ...
  3. pointer to the scratch memory should be aligned on 16-byte boundary
-------------------------------------------------------------------------*/
