...
typedef const float16_t * cfloat16ptr_t;
...
float16_t scl_reciphf(float16_t x);
float32_t scl_realabsinvf (float32_t x);
float16_t scl_realabsinvhf (float16_t x);
void 	vec_realabsinvf   (const float32_t*  x, float32_t* y,  int N);
void 	vec_recipf (float32_t* z, float32_t* x, int N);
void 	vec_realabsinvhf (float16_t* x, const float16_t* y,  int N);
void 	vec_reciphf(float16_t* x, float16_t* y, int N);
