...
void cmtx_inv4x4f  (void* pScr, complex_float *x);
void cmtx_inv6x6f  (void* pScr, complex_float *x);
void cmtx_inv8x8f  (void* pScr, complex_float *x);
void cmtx_inv10x10f(void* pScr, complex_float *x);
...
size_t cmtx_inv4x4f_getScratchSize        ();
size_t cmtx_inv6x6f_getScratchSize        ();
size_t cmtx_inv8x8f_getScratchSize        ();
size_t cmtx_inv10x10f_getScratchSize      ();
...
void mtx_gjelim6x6f   (void* pScr, float32_t *y, const float32_t* A,const float32_t * x);
void mtx_gjelim8x8f   (void* pScr, float32_t *y, const float32_t* A,const float32_t * x);
void mtx_gjelim10x10f (void* pScr, float32_t *y, const float32_t* A,const float32_t * x);
...
void cmtx_gjelim6x6f  (void* pScr, complex_float *y, const complex_float *A, const complex_float *x);
void cmtx_gjelim8x8f  (void* pScr, complex_float *y, const complex_float *A, const complex_float *x);
...
size_t mtx_gjelim6x6f_getScratchSize   ();
size_t mtx_gjelim8x8f_getScratchSize   ();
size_t mtx_gjelim10x10f_getScratchSize ();
size_t cmtx_gjelim2x2f_getScratchSize  ();
size_t cmtx_gjelim3x3f_getScratchSize  ();
size_t cmtx_gjelim4x4f_getScratchSize  ();
size_t cmtx_gjelim6x6f_getScratchSize  ();
size_t cmtx_gjelim8x8f_getScratchSize  ();
