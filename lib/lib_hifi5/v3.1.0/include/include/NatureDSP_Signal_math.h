...
void vec_sqrtf 			(float32_t*  z, float32_t* x, int N);
void vec_dividef (float32_t *z, const float32_t * x, const float32_t *y, int N);
void vec_sqrthf(float16_t* z, float16_t* x, int N);
void vec_dividehf (float16_t *z,const float16_t * x, const float16_t *y, int N);
...
float16_t scl_sqrthf(float16_t x);
float16_t scl_dividehf(float16_t x, float16_t y);
...
void vec_sinehf		   ( float16_t * y, const float16_t * x, int N );
void vec_cosinehf	   ( float16_t * y, const float16_t * x, int N );
void vec_log10hf	   ( float16_t * y, const float16_t * x, int N );
void vec_antilog10hf   ( float16_t * y, const float16_t * x, int N );
...
void vec_tanh_fp16(float16_t * y, const float16_t * x,int N);
...
void vec_sigmoid_fp16(float16_t * y, const float16_t * x, int N);
