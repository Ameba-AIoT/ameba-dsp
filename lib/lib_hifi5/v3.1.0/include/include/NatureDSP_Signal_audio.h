...
/*===========================================================================
  ...
  htkdelta             Compute first order regression coefficients
===========================================================================*/
...
/*-------------------------------------------------------------------------
  ...
  Restrictions:
  cepstra[],speech[]          Must not overlap, and must be aligned by 16-bytes
  Fs                          8000 <= Fs <= 48000
  fftSize                     256, 512, 1024 or 2048
 ...
 * and y[fftSize/2+1] do not overlap, and are aligned by 16-bytes. The FFT function is allowed to re-use the input
