...
/*===========================================================================
  ...
  kalmanupd1  Kalman filter update
===========================================================================*/
...
void bqriirf_df1_nd_coeffConfig( bqriirf_df1_nd_handle_t restrict _bqriir, const float32_t *coef_sos );
void bqriirf_df2_nd_coeffConfig( bqriirf_df2_nd_handle_t restrict _bqriir, const float32_t *coef_sos );
void bqriirf_df2t_nd_coeffConfig( bqriirf_df2t_nd_handle_t restrict _bqriir, const float32_t *coef_sos );
void bqriirf_df1_nd_stateConfig( bqriirf_df1_nd_handle_t restrict _bqriir, const float32_t * state_sos );
void bqriirf_df2_nd_stateConfig( bqriirf_df2_nd_handle_t restrict _bqriir, const float32_t * state_sos );
void bqriirf_df2t_nd_stateConfig( bqriirf_df2t_nd_handle_t restrict _bqriir, const float32_t * state_sos );
