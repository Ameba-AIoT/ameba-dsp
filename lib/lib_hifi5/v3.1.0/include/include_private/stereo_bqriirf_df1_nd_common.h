...
/*                      All Rights Reserved.                                */
/* ------------------------------------------------------------------------ */
#ifndef STEREO_BQRIIRF_DF1_ND_COMMON_H__
#define STEREO_BQRIIRF_DF1_ND_COMMON_H__
...
#include "bqriirf_df1_nd.h" // @@@@@@@@@@@

/* Instance pointer validation number. */
#define STEREO_BQRIIRF_DF1_ND_MAGIC 0xf37a05c1

/* Filter instance structure. */
typedef struct tag_stereo_bqriirf_df1_nd_t
{
...
} stereo_bqriirf_df1_nd_t, *stereo_bqriirf_df1_nd_ptr_t;

#endif /* STEREO_BQRIIRF_DF1_ND_COMMON_H__ */
