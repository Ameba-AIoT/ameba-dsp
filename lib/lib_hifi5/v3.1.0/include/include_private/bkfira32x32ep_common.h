...
/*                      All Rights Reserved.                                */
/* ------------------------------------------------------------------------ */
#ifndef BKFIRA32X32EP_COMMON_H__
#define BKFIRA32X32EP_COMMON_H__

/* Portable data types. */
#include "NatureDSP_types.h"
#include "common.h"

#define BKFIRA32X32EP_MAGIC     0xf949b88e

/* Filter instance structure. */
typedef struct tag_bkfira32x32ep_t
{
...
} bkfira32x32ep_t, *bkfira32x32ep_ptr_t;
