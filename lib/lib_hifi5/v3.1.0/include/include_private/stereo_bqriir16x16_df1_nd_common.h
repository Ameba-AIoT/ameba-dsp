...
/*                      All Rights Reserved.                                */
/* ------------------------------------------------------------------------ */
#ifndef STEREO_BQRIIR16X16_DF1_ND_COMMON_H__
#define STEREO_BQRIIR16X16_DF1_ND_COMMON_H__
...
#define STEREO_BQRIIR16X16_DF1_ND_MAGIC 0xc830d46a

/* Filter instance structure. */
typedef struct tag_stereo_bqriir16x16_df1_nd_t
{
	uint32_t magic;    // Instance pointer validation number
	bqriir16x16_df1_nd_handle_t bqriir_left;
	bqriir16x16_df1_nd_handle_t bqriir_right;
...
} stereo_bqriir16x16_df1_nd_t, *stereo_bqriir16x16_df1_nd_ptr_t;

#endif /* STEREO_BQRIIR16X16_DF1_ND_COMMON_H__ */
