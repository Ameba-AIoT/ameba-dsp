...
/*
    ...
    complex FFT stages for 32x16 FFTs
	IntegrIT, 2006-2018
*/

#ifndef __FFT_32X16_STAGES_H__
#define __FFT_32X16_STAGES_H__
#include "NatureDSP_types.h"
#include "fft_x16_common.h"

/*
 * Pointer to functions which implement complex 32x16 FFTs stage 
 */
typedef int (*fft_cplx32x16_stage_t)(const int16_t *tw, const int32_t *x, int32_t *y, int N, int *v, int tw_step, int *bexp);

/*
 *  32x16 FFT stages, scalingOption=2    
 */
...
int fft_32x16_stage_inner_scl2_DFT4x2_v4    (const int16_t *tw, const int32_t *x, int32_t *y, int N, int *v, int tw_step, int *bexp);
...
int ifft_32x16_stage_last_scl2_DFT4        (const int16_t *tw, const int32_t *x, int32_t *y, int N, int *v, int tw_step, int *bexp);
int ifft_32x16_stage_last_scl2_DFT8        (const int16_t *tw, const int32_t *x, int32_t *y, int N, int *v, int tw_step, int *bexp);
...
int fft_32x16_stage_inner_scl2_DFT4x4      (const int16_t *tw, const int32_t *x, int32_t *y, int N, int *v, int tw_step, int *bexp);
int fft_32x16_stage_second_scl2_DFT4       (const int16_t *tw, const int32_t *x, int32_t *y, int N, int *v, int tw_step, int *bexp); 
int fft_32x16_stage_last_scl2_DFT16        (const int16_t *tw, const int32_t *x, int32_t *y, int N, int *v, int tw_step, int *bexp);
int ifft_32x16_stage_last_scl2_DFT16       (const int16_t *tw, const int32_t *x, int32_t *y, int N, int *v, int tw_step, int *bexp);

/* Table of 32x16 FFT stages with dynamic scaling used in processing */
//extern const fft_cplx32x16_stage_t fft32x16_stages_scl2_tbl[NUM_FFT_STAGE_TYPES];

/*
 *  32x16 FFT stages, scalingOption=3
 */
...
int fft_32x16_stage_inner_scl3_DFT5_v4      (const int16_t *tw, const int32_t *x, int32_t *y, int N, int *v, int tw_step, int *bexp);
...
int ifft_32x16_stage_last_scl3_DFT3        (const int16_t *tw, const int32_t *x, int32_t *y, int N, int *v, int tw_step, int *bexp);
int ifft_32x16_stage_last_scl3_DFT5        (const int16_t *tw, const int32_t *x, int32_t *y, int N, int *v, int tw_step, int *bexp);
int fft_32x16_stage_inner_scl3_DFT4x4      (const int16_t *tw, const int32_t *x, int32_t *y, int N, int *v, int tw_step, int *bexp);
int fft_32x16_stage_second_scl3_DFT4       (const int16_t *tw, const int32_t *x, int32_t *y, int N, int *v, int tw_step, int *bexp);
int fft_32x16_stage_last_scl3_DFT16        (const int16_t *tw, const int32_t *x, int32_t *y, int N, int *v, int tw_step, int *bexp);
...
//extern const fft_cplx32x16_stage_t fft32x16_stages_scl3_tbl[NUM_FFT_STAGE_TYPES];

#endif // __FFT_32X16_STAGES_H__
