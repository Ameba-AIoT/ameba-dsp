...
typedef struct {
	...
	u32 CODEC_SelRxI2STdm;				/*!< Specifies the AUDIO CODEC Rx I2S TDM MODE
										This parameter can be a value of @ref I2S_TDM_MODE_SEL */
...
/** @defgroup CODEC_channel_len AUDIO Codec Channel Len
  * @{
  */
...
/** @defgroup CODEC_data_format AUDIO CODEC Interface Format
  * @{
  */
...
/** @defgroup I2S_TDM_MODE_SEL AUDIO Codec Selection of TDM Mode
  * @{
  */
...
/** @defgroup AUDIO CODEC DMIC Clock SEL
  * @{
  */
...
/** @defgroup AUDIO CODEC PDM Clock SEL
  * @{
  */
