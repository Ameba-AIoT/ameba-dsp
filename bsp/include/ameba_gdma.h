...
bool GDMA_ChnlRegister(u8 GDMA_Index, u8 GDMA_ChNum);
void GDMA_ChnlUnRegister(u8 GDMA_Index, u8 GDMA_ChNum);
u8	 GDMA_ChnlAlloc(u8 GDMA_Index, IRQ_FUN IrqFun, u32 IrqData, u32 IrqPriority);
void GDMA_ChnlFree(u8 GDMA_Index, u8 GDMA_ChNum);
