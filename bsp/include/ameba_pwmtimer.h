...
/**************************************************************************//**
 * @defgroup AMEBAD2_PWMTIMER
 * @{
 * @brief AMEBAD2_PWMTIMER Register Declaration
 *****************************************************************************/
typedef struct {
...
/** @defgroup TIM9_CC0_Pulse_Mode_definitions
  * @{
  */
...
/** @defgroup TIMBasic_ARR_definitions
  * @{
  */
...
/** @defgroup TIMBasic_CNT_definitions
  * @{
  */
...
/** @defgroup TIMx_Phase_Sync_definitions
  * @{
  */
...
void RTIM_TimeBaseInit(RTIM_TypeDef *TIMx, RTIM_TimeBaseInitTypeDef *TIM_InitStruct, IRQn_Type   IrqNum,
...
u32 RTIM_GetFlagStatus(RTIM_TypeDef *TIMx, u32 TIM_FLAG);
