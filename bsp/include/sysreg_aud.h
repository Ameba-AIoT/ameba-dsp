...
#define AUD_BIT_LDO_CODEC_DISCHARGE_PATH    ((u32)0x00000001 << 5)          /*!<R/W 0  LDO_CODEC_DISCHARGE_PATH selection for discharge path of LDO_CODEC 0:discharge path is turned off (default) 1:1.8kohm discharge path is turned on */
...
/**************************************************************************//**
 * @defgroup AMEBALITE_AUD
 * @{
 * @brief AMEBALITE_AUD Register Declaration
 *****************************************************************************/
typedef struct {
