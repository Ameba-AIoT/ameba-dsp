...
/**************************************************************************//**
 * @defgroup AMEBADLITE_SPORT
 * @{
 * @brief AMEBADLITE_SPORT Register Declaration
 *****************************************************************************/
typedef struct {
...
/**
  * @brief	AUDIO SPORT Register structure definition
  */
typedef struct {
...
typedef struct {
	...
	u32 SP_SetMultiIO;	/*!< Specifies the AUDIO SPORT selection of Tx MultiIO Mode
								This parameter can be a value of @ref SP_SetTxMultiIO */

	u32 SP_SelClk;		   /*AUDIO SPORT clock sources, 40/98.304/45.158/24.576MHz*/

	u32 SP_Bclk;	  /*!< Specifies the AUDIO SPORT selection of Tx MultiIO Mode
							  This parameter can be a value of @ref SP_SetTxMultiIO */
	u32 SP_Fix_Bclk;
...
/** @defgroup SP_application_mode AUDIO SPORT Application Mode
* @{
*/
...
bool AUDIO_SP_TXGDMA_Init(u32 Index, u32 SelGDMA, GDMA_InitTypeDef *GDMA_InitStruct, void *CallbackData,
						  IRQ_FUN CallbackFunc, u8 *pTxData, u16 Length);
bool AUDIO_SP_RXGDMA_Init(u32 Index, u32 SelGDMA, GDMA_InitTypeDef *GDMA_InitStruct, void *CallbackData,
						  IRQ_FUN CallbackFunc, u8 *pRxData, u16 Length);
bool AUDIO_SP_TXGDMA_Restart(u8 GDMA_Index, u8 GDMA_ChNum,	u32 TX_addr,	u16 TX_length);
bool AUDIO_SP_RXGDMA_Restart(u8 GDMA_Index,	u8 GDMA_ChNum,	u32 RX_addr,	u16 RX_length);
