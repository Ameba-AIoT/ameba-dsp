...
/**************************************************************************//**
 * @defgroup AMEBALITE_WDG
 * @{
 * @brief AMEBALITE_WDG Register Declaration
 *****************************************************************************/
typedef struct {
...
void WDG_Reset_Bypass(WDG_TypeDef *WDG, u32 NewState);
void WDG_Reset_Timeout(u32 Timeout);
void WDG_Reset_ClearINT(WDG_TypeDef *WDG);
/**
  * @}
  */
