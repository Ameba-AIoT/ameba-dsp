...
#ifndef _AMEBADLITE_VADBUF_H_
#define _AMEBADLITE_VADBUF_H_
...
/**************************************************************************//**
 * @defgroup AMEBADLITE_VADBUF
 * @{
 * @brief AMEBADLITE_VADBUF Register Declaration
 *****************************************************************************/
typedef struct {
...
void AUDIO_CODEC_SetVADDetThr(u32 threshold, u32 voice_level);
...
/** @defgroup VAD Buffer single block index
  * @{
  */
...
/** @defgroup VAD Buffer double block index
  * @{
  */
...
/** @defgroup VAD Buffer triple block index
  * @{
  */
...
/** @defgroup VAD Buffer quad block index
  * @{
  */
...
/** @defgroup VAD Buffer transfer mode
  * @{
  */
