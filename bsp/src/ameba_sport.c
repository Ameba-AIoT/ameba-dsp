...
)
{
	...
	DCache_CleanInvalidate((void *)pTXData, Length);
	//xthal_dcache_region_writeback((void*)pTXData, Length);
	//xthal_dcache_region_invalidate((void*)pTXData, Length);
	...
	GDMA_BurstEnable(GDMA_InitStruct->GDMA_ChNum, ENABLE);
...
{
	u8 GdmaChnl;
	DCache_CleanInvalidate((void *)pRXData, Length);
	//xthal_dcache_region_writeback((void*)pRXData, Length);
	//xthal_dcache_region_invalidate((void*)pRXData, Length);
...
)
{
	...
	DCache_CleanInvalidate((void *)TX_addr, TX_length);

	//xthal_dcache_region_writeback((void*)TX_addr, TX_length);
	//xthal_dcache_region_invalidate((void*)TX_addr, TX_length);
...
)
{
	...
	DCache_CleanInvalidate((void *)RX_addr, RX_length);
	//xthal_dcache_region_writeback((void*)RX_addr, RX_length);
	//xthal_dcache_region_invalidate((void*)RX_addr, RX_length);
