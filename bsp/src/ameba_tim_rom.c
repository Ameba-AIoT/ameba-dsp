...
/**
  ...
  * @retval None
  */
__weak void RTIM_TimeBaseStructInit(RTIM_TimeBaseInitTypeDef *TIM_InitStruct)
{
...
/**
  ...
  * @param  IrqNum: TIMx IRQ num.This parameter can be TIMx_irq[x]
  *         where x can be 0-14 corresponding to TIMx
  ...
  * @retval  none
  */
__weak void RTIM_TimeBaseInit(RTIM_TypeDef *TIMx, RTIM_TimeBaseInitTypeDef *TIM_InitStruct, IRQn_Type IrqNum, IRQ_FUN UserCB,
							  u32 UserCBData)
{
	u32 tmpCR = 0;
	u32 Status;
	...
	if (UserCB) {
		InterruptRegister(UserCB, (uint32_t)IrqNum, UserCBData, 14);
		InterruptEn((uint32_t)IrqNum, 14);

		//xtos_set_interrupt_handler(IrqNum + 7, UserCB, (void*)(&UserCBData), NULL);
		//xtos_interrupt_enable(IrqNum + 7);

		//xt_set_interrupt_handler(IrqNum + 7, UserCB, (void*)(UserCBData));
		//xt_ints_on( ( 1 << (IrqNum + 7)) );
		//DiagPrintf("IrqNum is %d\n", IrqNum);
...
/**
  ...
  * @param  TIMx: where x can be 0-14 to select the TIMx peripheral.
  * @param  NewState: new state of the TIMx peripheral.
  *   This parameter can be: ENABLE or DISABLE.
  * @retval None
  */
__weak void RTIM_Cmd(RTIM_TypeDef *TIMx, u32 NewState)
{
	/* Check the parameters */
	assert_param(IS_TIM_ALL_TIM(TIMx));
...
/**
  ...
  * @retval None
  */
__weak void RTIM_DeInit(RTIM_TypeDef *TIMx)
{
	/* Check the parameters */
	assert_param(IS_TIM_ALL_TIM(TIMx));
...
/**
  ...
  */
__weak u32 RTIM_GetCount(RTIM_TypeDef *TIMx)
{
	u32 TimerCountOld;
	u32 TimerCountNew;
	u32 TimerRDCnt;
...
/**
  ...
  *     @arg TIM_IT_Update: TIM update Interrupt source (TIM0-14)
  ...
  *     @arg TIM_IT_CC6: TIM Capture Compare 6 Interrupt source (TIM8)
  *     @arg TIM_IT_CC7: TIM Capture Compare 7 Interrupt source (TIM8)
  ...
  *     @arg TIM_IT_UIE6: TIM Update Event 6 Interrupt source (TIM8)
  *     @arg TIM_IT_UIE7: TIM Update Event 7 Interrupt source (TIM8)
  * @param NewState: ENABLE or DISABLE
  * @note
  *   - TIM0-7 and TIM10-14 can generate only an TIM_IT_Update interrupt.
  *   - TIM9 can generate TIM_IT_Update and TIM_IT_CC0 interrupt.
  *   - TIM8 can generate all interrupts.
  * @retval None
  */
__weak void RTIM_INTConfig(RTIM_TypeDef *TIMx, u32 TIM_IT, u32 NewState)
{
	/* Check the parameters */
	assert_param(IS_TIM_ALL_TIM(TIMx));
...
/**
  ...
  * @retval None
  */
__weak void RTIM_INTClear(RTIM_TypeDef *TIMx)
{
	u32 CounterIndex = 0;
	u32 Status = TIMx->SR;
...
/**
  ...
  * @retval None
  */
__weak void RTIM_INTClearPendingBit(RTIM_TypeDef *TIMx, u32 TIM_IT)
{
	u32 CounterIndex = 0;
...
/**
  ...
  */
__weak u32 RTIM_GetFlagStatus(RTIM_TypeDef *TIMx, u32 TIM_FLAG)
{
	u32 bitstatus = false;
...
/**
  ...
  */
__weak u32 RTIM_GetINTStatus(RTIM_TypeDef *TIMx, u32 TIM_IT)
{
	u32 bitstatus = false;
